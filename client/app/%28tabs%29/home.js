      ...
      >
        ...
        <SoftCard style={styles.outfitCard}>
          ...
          <View style={{ marginTop: 22, width: "100%" }}>
            <PrimaryButton title="Generate Outfit ✨" onPress={() => {}} />
          </View>
        </SoftCard>
          ...
          {loadingWardrobe ? (
            ...
            <>
              ...
              <Text style={styles.totalLabel}>
                {wardrobeStats.total === 1 ? "piece" : "pieces"} waiting to be loved ✨
              </Text>

              <View style={styles.stats}>
                <View style={styles.stat}>
                  <Text style={styles.number}>{wardrobeStats.tops}</Text>
                  <Text style={styles.label}>Tops</Text>
                </View>
                <View style={styles.stat}>
                  <Text style={styles.number}>{wardrobeStats.bottoms}</Text>
                  <Text style={styles.label}>Bottoms</Text>
                </View>
                <View style={styles.stat}>
                  <Text style={styles.number}>{wardrobeStats.shoes}</Text>
